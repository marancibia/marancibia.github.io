...
Quick 10-minute overview of the Lab: 
[] (youtube:Qwsw_AjLZ1Y)
...
* [Subscribe to the Weekly AskTOM Oracle Machine Learning Office Hours](https://asktom.oracle.com/pls/apex/asktom.search?office=6801#sessions)
* [Oracle Machine Learning AutoML UI Demo](https://youtu.be/yJGsfU9cmt0)
* [Oracle Machine Learning for Python Demo](https://youtu.be/bqxlpdgrMAg)
